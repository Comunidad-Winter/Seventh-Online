...
Image1.Picture = LoadPicture(App.Path & "\Graficos\Interfaces\Botónok.jpg")
...
For I = 0 To NUMSKILLS * 2 - 1
    If I Mod 2 = 0 Then
        Command1(I).Picture = LoadPicture(App.Path & "\Graficos\Interfaces\BotónMás.jpg")
    Else
        Command1(I).Picture = LoadPicture(App.Path & "\Graficos\Interfaces\BotónMenos.jpg")
    End If
Next
