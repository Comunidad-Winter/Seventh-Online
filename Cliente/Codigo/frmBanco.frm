...
End If
    lblInfo.Caption = "Bienvenido a la cadena de finanzas Goliath. Tienes " & PonerPuntos(UserGLD) & " monedas de oro en tu billetera y en tu cuenta tienes " & PonerPuntos(UserGLDBOV) & " Monedas de oro. y " & UserBOVItem & " items en tu Boveda. ¿Cómo te puedo ayudar?"
End Sub
