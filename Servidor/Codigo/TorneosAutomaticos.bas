...
Private Const mapatorneo As Integer = 81
' esquinas superior isquierda del ring
Private Const esquina1x As Integer = 40
Private Const esquina1y As Integer = 15
' esquina inferior derecha del ring
Private Const esquina2x As Integer = 59
Private Const esquina2y As Integer = 35
' Donde esperan los tios
Private Const esperax As Integer = 23
Private Const esperay As Integer = 58
' Mapa desconecta
...
Private Const X2 As Integer = 24
Private Const Y1 As Integer = 58
Private Const Y2 As Integer = 59
...
End If
    ...
    If (Torneo_Rondas = 1) Then
        ...
        Call SendData(SendTarget.toall, 0, 0, "||PREMIO: 30 Puntos de Torneo." & FONTTYPE_GUILD)
        UserList(Torneo_Luchadores(LI1)).Stats.PuntosTorneo = UserList(Torneo_Luchadores(LI1)).Stats.PuntosTorneo + 30
...
On Error GoTo errorh
Call SendData(SendTarget.toall, 0, 0, "||Torneo: " & UserList(userindex).name & " se desconecto en Torneo Automatico, se le penaliza con 2 Puntos de Torneo!" & FONTTYPE_TALK)
