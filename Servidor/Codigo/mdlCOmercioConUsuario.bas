...
Else
    ...
    Call SendData(SendTarget.ToIndex, Origen, 0, "||Le has mandado una solicitud de comercio a " & UserList(Destino).name & ", ahora debes esperar que acepte." & FONTTYPE_TALK)
